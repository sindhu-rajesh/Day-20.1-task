...
function showBreedImage(index) {
  document.getElementById(
    "breed_image"
  ).src = ` ${ArrayBreeds[index].image.url}`;
  document.getElementById(
    "title"
  ).innerHTML = `Name : ${ArrayBreeds[index].name}`;
  document.getElementById(
    "cc"
  ).innerHTML = `Country_Code :&nbsp;&nbsp;${ArrayBreeds[index].country_code}`;
  document.getElementById(
    "ls"
  ).innerHTML = `Life_Span&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp; ${ArrayBreeds[index].life_span}`;
  ...
  document.getElementById("wiki_link").innerHTML =
    ArrayBreeds[index].wikipedia_url;
}